module.exports = async (req, res) => {
  ...
  try {
    ...
    // 2. Se o pagamento NÃO estiver aprovado, retorna apenas o status sem entregar nenhum link
    ...
    // 3. Pagamento APROVADO: busca com segurança os links legítimos de download dos produtos comprados
    let downloadLinks = [];
    try {
    ...
    // Retorna aprovação com os links autorizados
    return res.status(200).json({
      id: paymentData.id,
      status: "approved",
      status_detail: paymentData.status_detail,
